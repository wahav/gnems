...
(function ($, kendo) {
    ...
    // Todo Model Object
    app.Student = kendo.data.Model.define({
        id: 'id',
        fields: {
            id: {
                editable: false,
    ...
    app.Field = kendo.data.Model.define({
        id: 'id',
        fields: {
            id: {
                editable: false,
    ...
    app.Form = kendo.data.Model.define({
        id: 'id',
        fields: {
            id: {
                editable: false,
            ...
            questions : [{id:{editable:true}}]
        }
    });
    
    app.QuestionTemplate = kendo.data.Model.define({
        id: 'id',
        fields: {
            id: {
                editable: false,
    ...
    app.Question = kendo.data.Model.define({
        id: 'id',
        fields: {
            id: {
                editable: false,
    ...
    app.formTemplateData = new kendo.data.extensions.LocalStorageDataSource({
        itemBase: 'gnems-formTemplates',
        schema: {
            model: app.FormTemplate
        }
    });
    
    app.formData = new kendo.data.extensions.LocalStorageDataSource({
        itemBase: 'gnems-forms',
        schema: {
            model: app.Form
        }
    });
    
    app.studentData = new kendo.data.extensions.LocalStorageDataSource({
        itemBase: 'gnems-students',
        schema: {
            model: app.S
        }
    });
